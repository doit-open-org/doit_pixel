...
| 文档 | 说明 |
| --- | --- |
| [BLE 通信协议](CozyLife_ble_v1.cn.md) | BLE 广播、GATT 分帧、命令、配网与 OTA 的协议说明。 |
| [BLE Communication Protocol (English)](CozyLife_ble_v1.md) | BLE 传输层与设备通信协议的英文版。 |
| [CozyLife Pixel 蓝牙协议](CozyLife_Pixel_ble_protocol.cn.md) | Pixel 设备的数据点、模式、颜色格式、定时、文字和 2D DIY 数据协议。 |
| [CozyLife Pixel BLE Protocol (English)](CozyLife_Pixel_ble_protocol.md) | Pixel 数据点控制协议的英文版。 |
